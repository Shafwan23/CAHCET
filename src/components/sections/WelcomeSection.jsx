...
const WelcomeSection = ({ data }) => {
  const { title, subtitle, description, mission } = data || {};
  return (
          ...
          >
            ...
            <div className="relative md:absolute mt-4 md:mt-0 bottom-4 left-4 right-4 md:bottom-8 md:left-8 md:right-8 bg-white/90 backdrop-blur-md p-4 md:p-6 rounded-xl shadow-lg z-20 border border-primary-50">
              ...
              <div className="flex items-center gap-3">
                <div>
                  <h4 className="font-bold text-primary-900 text-sm">Dr. M. Sasikumar</h4>
                  <p className="text-primary-500 text-xs">Principal, CAHCET</p>
                </div>
              </div>
            </div>
          </motion.div>
              ...
              <div className="grid sm:grid-cols-2 gap-8">
                <div className="flex gap-4">
                  <div className="w-12 h-12 rounded-xl bg-primary-50 flex items-center justify-center shrink-0">
                    <span className="text-primary-900 font-bold">25+</span>
                  </div>
                  <div>
                    <h4 className="font-bold text-primary-900">Years of Legacy</h4>
                    <p className="text-sm text-primary-500">Excellence in education</p>
                  </div>
                </div>
                <div className="flex gap-4">
                  <div className="w-12 h-12 rounded-xl bg-primary-50 flex items-center justify-center shrink-0">
                    <span className="text-primary-900 font-bold">15k+</span>
                  </div>
                  <div>
                    <h4 className="font-bold text-primary-900">Alumni Globally</h4>
                    <p className="text-sm text-primary-500">Shaping the future</p>
                  </div>
                </div>
              </div>
            </motion.div>
