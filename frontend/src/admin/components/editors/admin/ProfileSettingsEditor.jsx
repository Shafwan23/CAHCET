...
import { Upload, User, Mail, Phone, Briefcase, Building2, Save, ShieldAlert } from 'lucide-react';
...
const ProfileSettingsEditor = () => {
  ...
  return (
    <EditorPage
      title="Enterprise Profile Center"
      description="Manage your account security and preferences."
      breadcrumb={['Admin', 'System', 'Profile']}
    >
      <motion.div initial={{opacity:0, y:20}} animate={{opacity:1, y:0}} transition={{duration:0.3}} className="grid grid-cols-1 xl:grid-cols-12 gap-8">
        <div className="xl:col-span-12 space-y-6">
          <div className="p-5 rounded-2xl border bg-slate-50 text-slate-700 border-slate-200 flex justify-between items-center">
            ...
            <div className="px-3 py-1 bg-white border border-slate-200 rounded-lg text-xs font-bold">system.profile</div>
          </div>
          
          <EditorCard title="Profile Configuration">
