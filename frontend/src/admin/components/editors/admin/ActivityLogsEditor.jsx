...
import { Search, Download, Clock, User, FileText, CheckCircle, Trash2, ArrowRight, Ban, Key, FileType2, ShieldAlert, Monitor } from 'lucide-react';
...
const ActivityLogsEditor = () => {
  ...
  return (
    <EditorPage
      ...
      description="Monitor system-wide activity and security events."
      breadcrumb={['Admin', 'System', 'Audit Logs']}
    >
      <motion.div initial={{opacity:0, y:20}} animate={{opacity:1, y:0}} transition={{duration:0.3}} className="grid grid-cols-1 xl:grid-cols-12 gap-8">
        <div className="xl:col-span-12 space-y-6">
          <div className="p-5 rounded-2xl border bg-slate-50 text-slate-700 border-slate-200 flex justify-between items-center">
            ...
            <div className="px-3 py-1 bg-white border border-slate-200 rounded-lg text-xs font-bold">system.audit</div>
          </div>
          <EditorCard title="Security Events">
